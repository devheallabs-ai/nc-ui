...
If you are working on the legacy JavaScript compatibility layer inside this repo,
Node.js is optional and only needed for direct `cli.js` and `tests/*.js` maintenance.
...
nc ui build examples/landing.ncui
```

### Build a Sample

```bash
nc ui build samples/hello.ncui
```
