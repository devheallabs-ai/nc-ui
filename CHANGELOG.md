...
#### Legacy JS Compatibility Layer (optional)

The original JavaScript compiler is retained only for compatibility maintenance
inside this repository. It is not required for normal NC UI usage.
