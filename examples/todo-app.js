...
async function action_addTask(text){
  _addTo("tasks",text);
}
async function action_removeTask(index){
}
async function action_setFilter(value){
  _set("filter",value);
}
window.action_addTask=action_addTask;
window.action_removeTask=action_removeTask;
window.action_setFilter=action_setFilter;
